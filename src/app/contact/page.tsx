    ...
    <PublicLayout>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-8 py-16">
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            ...
            <div className="bg-[#161a1d] rounded-2xl p-6 border border-[#161a1d]/60">
              ...
              <pre className="text-sm font-mono leading-relaxed">
                ...
                <span className="text-gray-400 font-bold">const</span>
            ...
            {/* Info cards */}
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-warm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{dept['email'] || 'head@cse.kuet.ac.bd'}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-warm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{dept['phone'] || '+880-2477-733318'}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-warm flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium text-sm">{dept['address'] || 'KUET, Khulna-9203, Bangladesh'}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-warm flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-400 text-xs uppercase tracking-wider font-semibold">Office Hours</p>
                <p className="text-gray-900 font-medium text-sm">Sun – Thu, 8:00 AM – 5:00 PM</p>
              </div>
            </div>
            ...
            {socialLinks.length > 0 && (
              <div>
                <p className="text-gray-600 font-bold text-sm mb-3">Follow Us</p>
                <div className="flex gap-3">
                  {socialLinks.map(s => {
                    const Icon = socialIcons[s.icon || ''] || Mail;
                    return (
                      <a key={s.id} href={s.url} target="_blank" rel="noopener noreferrer"
                        className="w-11 h-11 rounded-xl bg-gray-50 flex items-center justify-center text-gray-600 hover:bg-gray-700 hover:text-white transition-all duration-300">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 md:p-10 border border-gray-200 shadow-warm-lg space-y-6">
              <div>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label className="block text-gray-600 text-xs font-bold uppercase tracking-wider mb-2">Your Name</label>
                  <input type="text" required value={form.name} onChange={e => setForm({ ...form, name: e.target.value })}
                    placeholder="John Doe"
                    className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400
                      focus:outline-none focus:border-[#D4A574] focus:ring-2 focus:ring-indigo-300/20 transition-all" />
                </div>
                <div>
                  <label className="block text-gray-600 text-xs font-bold uppercase tracking-wider mb-2">Your Email</label>
              ...
              <div>
                <label className="block text-gray-600 text-xs font-bold uppercase tracking-wider mb-2">Subject</label>
              ...
              <div>
                <label className="block text-gray-600 text-xs font-bold uppercase tracking-wider mb-2">Message</label>
                <textarea required rows={5} value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
                  placeholder="Your message..."
                  className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400
                    focus:outline-none focus:border-[#D4A574] focus:ring-2 focus:ring-indigo-300/20 transition-all resize-none" />
              </div>
      ...
      {dept['map_embed_url'] && (
        <section className="max-w-6xl mx-auto px-6 md:px-8 pb-16">
          <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-warm h-80">
