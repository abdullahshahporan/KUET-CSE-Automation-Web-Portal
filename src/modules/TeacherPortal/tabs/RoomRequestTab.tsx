    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white dark:bg-[#161a1d] rounded-xl border border-gray-200 dark:border-[#3d4951]/50 p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-gray-400 dark:text-[#b1a7a6] mb-1">Start Time *</label>
              <input type="time" value={form.start_time} onChange={e => updateField('start_time', e.target.value)} className={inputClass} required />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-400 dark:text-[#b1a7a6] mb-1">End Time *</label>
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button type="submit" disabled={saving || !form.room_number || !form.purpose} className="px-4 py-2 bg-gray-600 dark:bg-red-600 text-white rounded-lg text-sm font-medium disabled:opacity-50 flex items-center gap-2">
