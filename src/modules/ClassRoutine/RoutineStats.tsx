...
export default function RoutineStats({ displaySlots }: RoutineStatsProps) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <SpotlightCard
        className="rounded-xl p-4 border border-gray-200 dark:border-gray-300"
        spotlightColor="rgba(217, 162, 153, 0.2)"
      >
        <p className="text-sm text-gray-400 dark:text-white/50">Total Slots</p>
        <p className="text-2xl font-bold text-gray-700 dark:text-white">{displaySlots.length}</p>
      </SpotlightCard>
      ...
      <SpotlightCard
        ...
        spotlightColor="rgba(217, 162, 153, 0.2)"
      >
        <p className="text-sm text-gray-400 dark:text-white/50">Courses</p>
        <p className="text-2xl font-bold text-indigo-500 dark:text-[#00e5ff]">{uniqueCourses}</p>
      </SpotlightCard>
      ...
      <SpotlightCard
        ...
        spotlightColor="rgba(217, 162, 153, 0.2)"
      >
        <p className="text-sm text-gray-400 dark:text-white/50">Rooms Used</p>
        <p className="text-2xl font-bold text-indigo-500 dark:text-[#8400ff]">{uniqueRooms}</p>
      </SpotlightCard>
      ...
      <SpotlightCard
        ...
        spotlightColor="rgba(217, 162, 153, 0.2)"
      >
        <p className="text-sm text-gray-400 dark:text-white/50">Teachers</p>
