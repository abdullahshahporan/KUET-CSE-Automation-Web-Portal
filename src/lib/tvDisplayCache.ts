// ==========================================
// TV Display Cache — Local offline data storage
 ...
 * Browser: Uses navigator.onLine + online/offline events
 * Electron: Uses navigator.onLine
 */
export function useNetworkStatus(): [isOnline: boolean, setIsOnline: (online: boolean) => void] {
